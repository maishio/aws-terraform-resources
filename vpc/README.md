# Amazon VPC (Virtual Private Cloud) Resources

## Resources

This repository includes Terraform configurations for the following Amazon VPC resources:

- [Amazon VPC ](./vpc)
- [Amazon VPC Endpoint](./endpoint)
- [Amazon VPC Flow Log](./flow_log)
